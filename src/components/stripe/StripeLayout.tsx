  ...
  return (
    <div className="flex min-h-screen bg-gbs-bg-primary font-sans no-scrollbar">
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 h-14 bg-gbs-bg-secondary border-b border-gbs-border px-4 flex items-center justify-between z-50">
        <button
          className="text-gbs-text-primary text-xl p-2"
      ...
      >
        <div className="p-5 flex items-center justify-between border-b border-gbs-border">
          ...
          >
            ...
            {!sidebarCollapsed && (
              <span className="font-bold text-xl text-gbs-text-primary whitespace-nowrap">
                GBS Pay
              </span>
            )}
          </div>
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {isActive && (
                  <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-5 bg-gbs-accent-DEFAULT rounded-r" />
                )}
              </button>
            );
          })}
        ...
        <div className="p-4 border-t border-gbs-border">
          <div className="flex items-center gap-2 px-3 py-2 bg-gbs-bg-card rounded">
            <svg
              viewBox="0 0 60 25"
              className="w-10 h-4 text-[#635BFF] shrink-0"
            >
              <path
                d="M5 10.2c0-.7.6-1 1.5-1 1.3 0 3 .4 4.3 1.1V6.7c-1.4-.6-2.9-.8-4.3-.8C3.4 5.9 1 7.8 1 10.5c0 4.2 5.7 3.5 5.7 5.3 0 .8-.7 1.1-1.7 1.1-1.5 0-3.4-.6-4.9-1.4v3.6c1.7.7 3.3 1 4.9 1 3.2 0 5.5-1.6 5.5-4.3-.1-4.5-5.5-3.7-5.5-5.6z"
                fill="currentColor"
              />
              <path
                d="M14.4 2.3l-4 .9V6.7l4-1v-3.4zM10.4 8h4v12h-4V8zM19.2 8l-.3-1h-3.5v12h4v-8.1c.9-1.2 2.5-1 3-.8V6.9c-.5-.2-2.5-.6-3.2 1.1zM24 8h4v12h-4V8zm0-4.7l4-.9v3.5l-4 .9V3.3zM33.6 5.9h-3.9v3.6h3.9V12c0 4.6 2.5 6.1 5.5 6.1 1.1 0 2.2-.3 2.9-.6v-3.1c-.6.3-1.4.4-2.3.4-1.3 0-2.1-.5-2.1-2.4V9.5h2.3v-3h-2.3V3.8l-4 .8v1.3z"
                fill="currentColor"
              />
              <path
                d="M48.8 5.9c-1.6 0-2.6.8-3.2 1.3l-.2-1h-3.5v16.1l4-.8v-3.9c.6.4 1.5 1 2.9 1 2.9 0 5.6-2.4 5.6-7.6-.1-4.7-2.7-5.1-5.6-5.1zm-1 9.7c-1 0-1.5-.4-1.9-.8v-6.3c.4-.5 1-.9 1.9-.9 1.5 0 2.5 1.6 2.5 4 0 2.5-1 4-2.5 4z"
                fill="currentColor"
              />
              <path
                d="M58.3 14c0-4.2-2-7.1-5.8-7.1s-6.1 3-6.1 7.1c0 4.7 2.7 7.1 6.6 7.1 1.9 0 3.3-.4 4.4-1v-3c-1.1.5-2.3.8-3.9.8-1.5 0-2.9-.6-3-2.4h7.7c0-.2.1-1 .1-1.5zm-7.8-1.5c0-1.8 1.1-2.5 2.1-2.5 1 0 2 .8 2 2.5h-4.1z"
                fill="currentColor"
              />
            </svg>
            {(!sidebarCollapsed || mobileMenuOpen) && (
              <span className="text-[11px] text-gbs-text-muted whitespace-nowrap">
                Powered by Stripe
              </span>
            )}
          </div>
